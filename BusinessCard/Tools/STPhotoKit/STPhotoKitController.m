...
- (void)viewDidLoad {
    ...
    [self.buttonConfirm mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self.buttonCancel);
    }];
...
- (UIButton *)buttonCancel
{
    if (!_buttonCancel) {
        ...
        _buttonCancel = [[UIButton alloc]initWithFrame:CGRectZero];
...
- (UIButton *)buttonConfirm
{
    if (!_buttonConfirm) {
        ...
        [_buttonConfirm setTitle:@"determine" forState:UIControlStateNormal];
...
- (UIButton *)buttonBack
{
    if (!_buttonBack) {
        ...
        [_buttonBack setTitle:@"recovery" forState:UIControlStateNormal];
