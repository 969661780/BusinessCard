//
//  MTFillConViewController.m
//  BusinessCard
//
//  Created by mt y on 2018/7/5.
...
@interface MTFillConViewController ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIActionSheetDelegate, STPhotoKitDelegate>
...
@implementation MTFillConViewController
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *,id> *)info
{
    [picker dismissViewControllerAnimated:YES completion:^{
        ...
        [photoVC setSizeClip:CGSizeMake(80, 80)];
...
- (IBAction)commitBtn:(UIButton *)sender {
    if (!self.headImage) {
        [SVProgressHUD showErrorWithStatus:@"Please add image"];
